...
class MixedPrecisionOptimizer(MegatronOptimizer):
    ...
    def _unscale_main_grads_and_check_for_nan(self):
        ...
        torch.cuda.nvtx.range_push(f"AP: {torch.distributed.get_rank()} :{self.found_inf.type}:{self.found_inf.shape}: parallel_model :optimizer: _unscale_main_grads_and_check_for_nan")
